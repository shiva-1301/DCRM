...
# Dynamic Contact Resistance Measurement (DCRM) – Technical Reference Guide
...
```
Open Contact
High Resistance (kΩ or clipped value)

Arc Contact Region
Resistance rapidly decreases

Main Contact Conduction
Low resistance (tens of µΩ)
```
...
| -------------- | ------------------------------- |
| Open contact   | 4000–8000 µΩ (instrument limit) |
| Arc region     | 300–3000 µΩ                     |
| Closed contact | 20–100 µΩ                       |
...
| ----------------------- | --------------- |
| HV breakers             | 120–200 mm      |
| Medium voltage breakers | 30–80 mm        |
...
| --------------------- | ------------- |
| Low voltage breakers  | 10–30 A       |
| High voltage breakers | 30–100 A      |
...
Healthy conduction resistance is typically **20–80 µΩ**.
...
| ------------ | -------------------- |
| 5–15 ms      | Normal               |
| 15–30 ms     | Moderate wear        |
| 30–40 ms     | Maintenance required |
...
| --------------------- | ------------- |
| Arc duration          | 5–20 ms       |
| Conduction resistance | 20–80 µΩ      |
| Contact travel        | 120–200 mm    |
| Closing velocity      | 3–4 m/s       |
| Opening velocity      | 6–7 m/s       |
| Operation delay       | 20–80 ms      |
...
Most DCRM instruments record **4000–6000 samples per operation**.
